...
final class LockScreenTimerWidgetPanelManager {
    ...
    private func hostingView() -> PassthroughHostingView<LockScreenTimerWidget> {
        ...
        // 圆角外透明区穿透点击（修复整块矩形吃点击）
        hosting.contentCornerRadius = LockScreenTimerWidget.cornerRadius
        hosting.contentSize = LockScreenTimerWidget.preferredSize
        return hosting
    }
