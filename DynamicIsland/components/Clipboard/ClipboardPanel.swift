    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            HStack {
                ...
                Image.cuteSymbol("doc.on.clipboard")
...
struct ClipboardPanelEmptyState: View {
    ...
    var body: some View {
        VStack(spacing: 12) {
            Image.cuteSymbol(hasSearch ? "magnifyingglass" : (isHistoryTab ? "doc.on.clipboard" : "heart.fill"))
                .font(.system(size: 32))
                .foregroundColor(.secondary)
            ...
            if isHovered {
                HStack(spacing: 6) {
                    ...
                    Button(action: {
                        ...
                        Image.cuteSymbol(isPinned ? "heart.fill" : "heart")
                            .font(.system(size: 11))
                    ...
                    Button(action: {
                        ...
                        Image.cuteSymbol(justCopied ? "checkmark.circle.fill" : "doc.on.doc")
                            .font(.system(size: 11))
