...
struct ColorPickerPanelView: View {
    ...
    private var headerSection: some View {
        VStack(spacing: 12) {
            ...
            HStack {
                ...
                HStack(spacing: 8) {
                    Image.cuteSymbol("eyedropper.halffull")
                ...
                HStack(spacing: 8) {
                    ...
                    Button(action: {
                        ...
                        HStack(spacing: 6) {
                            Image.cuteSymbol("plus.circle.fill")
    ...
    private var noSelectionView: some View {
        VStack(spacing: 16) {
            ...
            Image.cuteSymbol("hand.point.up.left")
                .font(.system(size: 32))
                .foregroundColor(.secondary)
